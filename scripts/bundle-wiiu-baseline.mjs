...
const sourceRoot = resolve(projectRoot, 'LocalAssets/wiiu/default');
const outputPath = resolve(projectRoot, 'public/assets/wiiu/default/wiiu-base-assets.zip');
...
console.log(`Bundled ${manifest.files.length} Wii U baseline files (${bytes.length} bytes).`);
